...
public class NotificationController {
    ...
    public String armazenarNotificacao(Model model, @RequestParam String mensagem, @RequestParam String tipo,
            @RequestParam String prioridade, @RequestParam String criacao) {
    ...
    public String salvarAtualizacaoNotificacao(Model model, @RequestParam String mensagem, @RequestParam String tipo,
            @RequestParam String prioridade, @RequestParam String criacao, @RequestParam int id) {
